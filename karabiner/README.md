# @theskumar's Karabiner Elements configuration
...
1. Create a symlink with `ln -s ~/github/theskumar/karabiner ~/.config` (where `~/github/theskumar/karabiner` is your local path to where you cloned the repository)
...
Copyright (c) 2022 Saurabh Kumar, licensed under the [MIT license](./LICENSE.md).
